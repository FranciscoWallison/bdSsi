...
<div class="container">
	...
	fornecendo ao Secretário de Segurança e seus gestores cadastrados, informações preciosas sobre os Distritos inseridos
	no sistema, dentre outros fatores que auxiliam na correta tomada de decisão das partes interessadas.
	
	Mais uma melhoria pensada para estimular o desenvolvimento do municípo de Itapioca!</p>
	<p>
		<a class="btn btn-primary btn-lg" href="http://www.itapipoca.ce.gov.br" role="button">Saiba mais »</a>
	</p>
